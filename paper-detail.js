...
function loadPaperDetails() {
    ...
    // 渲染研究背景
    document.getElementById('backgroundContent').textContent = currentPaperDetails.backgroundContent;
    
    // 渲染主要内容
    document.getElementById('mainContent').textContent = currentPaperDetails.mainContent;
    
    // 渲染主要结论
    document.getElementById('conclusionContent').textContent = currentPaperDetails.conclusionContent;
...
function editBackgroundContent() {
    ...
    `, () => {
        ...
        document.getElementById('backgroundContent').textContent = paperDetails[currentPaperId].backgroundContent;
...
function editMainContent() {
    const paperDetails = DataManager.load('paperDetails', {});
    const currentPaperDetails = paperDetails[currentPaperId] || { mainContent: '暂无主要内容信息' };
    ...
    `, () => {
        ...
        document.getElementById('mainContent').textContent = paperDetails[currentPaperId].mainContent;
...
function editConclusionContent() {
    const paperDetails = DataManager.load('paperDetails', {});
    const currentPaperDetails = paperDetails[currentPaperId] || { conclusionContent: '暂无主要结论信息' };
    ...
    `, () => {
        ...
        document.getElementById('conclusionContent').textContent = paperDetails[currentPaperId].conclusionContent;
