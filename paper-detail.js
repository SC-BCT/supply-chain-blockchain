    ...
    showConfirmModal('确定要删除这张图片吗？', () => {
        ...
        if (paperDetailsData[currentPaperId]) {
            if (containerId === 'homepageImages') {
                paperDetailsData[currentPaperId].homepageImages.splice(index, 1);
            } else if (containerId === 'keyImages') {
                paperDetailsData[currentPaperId].keyImages.splice(index, 1);
            }
        ...
        if (paperDetailsData[currentPaperId]) {
            if (containerId === 'homepageImages') {
                renderImages('homepageImages', paperDetailsData[currentPaperId].homepageImages || []);
            } else if (containerId === 'keyImages') {
                renderImages('keyImages', paperDetailsData[currentPaperId].keyImages || []);
            }
        }
