...
// 默认数据（如果data.json加载失败时使用）
const defaultData = {
    projectInfo: {
        name: "区块链赋能闭环供应链的动态运营策略和政府补贴机制研究",
        number: "72202113",
        leader: "马德青",
        duration: "2022.01 - 2025.12"
    },
    projectIntro: "本研究聚焦区块链技术与闭环供应链的深度融合，针对传统闭环供应链存在的信息不透明、溯源难、协同效率低等痛点，结合区块链不可篡改、可追溯的核心特性，系统探究动态环境下供应链的生产、回收、再制造全流程运营策略。同时，构建适配区块链赋能场景的政府补贴机制，分析补贴方式、力度对供应链主体决策及环境、经济双重效益的影响。研究旨在为闭环供应链数字化转型提供理论支撑，为政府制定精准有效的产业扶持政策提供实践参考。",
    papers: [
        {
            id: 1,
            title: "Internal reductions or carbon offset: How to achieve triple benefits in a consumer market with environmental concerns",
            journal: "International Journal of Production Economics",
            time: "2025",
            authors: "王雪，马德青*，胡劲松，刘霞",
            abstract: "本文研究了在具有环境关注的消费市场中，内部减排与碳补偿如何实现三重效益..."
        },
        {
            id: 2,
            title: "Lenient or mandatory? Emission reduction coordination in supply chains considering consumers' environmental concerns",
            journal: "Journal of Cleaner Production",
            time: "2025",
            authors: "刘霞，马德青*，胡劲松，李嘉亚",
            abstract: "本文研究了考虑消费者环境关注的供应链中，宽松或强制性的减排协调机制..."
        },
        {
            id: 3,
            title: "Marketplace, wholesale or hybrid: considering the role of blockchain implementation in countering consumer mistrust",
            journal: "Electronic Commerce Research",
            time: "2025",
            authors: "马德青，邵文博，张凯月，胡劲松*",
            abstract: "本文研究了在应对消费者不信任时，市场平台、批发或混合模式中区块链实施的作用..."
        },
        {
            id: 4,
            title: "How to leverage blockchain to react to consumer reference effects and develop a distribution strategy in online retailing?",
            journal: "Transportation Research Part E: Logistics and Transportation Review",
            time: "2024",
            authors: "马德青，李开富，胡劲松*，王雪",
            abstract: "本文研究了如何利用区块链应对消费者参考效应并制定在线零售分销策略..."
        }
    ],
    awards: [
        {
